...
LFGSort_Inst_ect = {};
	...
	LFGSort_Inst['[^А-ЯЁ%a]СМ[^А-ЯЁ%a]'] = 'МАО';
	LFGSort_Inst['[^А-ЯЁ%a]SM[^А-ЯЁ%a]'] = 'МАО';
	...
	LFGSort_Inst['МАРОД'] = 'МАРА';
	LFGSort_Inst['[^А-ЯЁ%a][Мм]ару'] = 'МАРА';
	-- 4. КТК
	LFGSort_Inst['[Тт]емного клыка'] = 'КТК';
	LFGSort_Inst['ТЕМНОГО КЛЫКА'] = 'КТК';
	LFGSort_Inst['[^А-ЯЁ%a]КТК[^А-ЯЁ%a]'] = 'КТК';
	LFGSort_Inst['[^А-ЯЁ%a]ктк'] = 'КТК';
	-- 5. ЛИ
	LFGSort_Inst['[^А-ЯЁ%a]ЛИ[^А-ЯЁ%a]'] = 'ЛИ'; -- без ИЛИ
	LFGSort_Inst['[лЛ]абиринты'] = 'ЛИ';
	-- 6. ГЧГ
	...
	-- 19. ОП
	LFGSort_Inst['[^А-ЯЁ%a]ОП[^А-ЯЁ%a]'] = 'ОП';
	-- 20. УБРС
	...
	LFGSort_Inst['[^А-ЯЁ%a]ЗГ[^А-ЯЁ%a]'] = 'ЗГ';
	...
	LFGSort_Inst['[^А-ЯЁ%a]АК 20'] = 'АК20';
	...
	-- 25. ОП
	LFGSort_Inst['[^А-ЯЁ%a|(по )]МС[^А-ЯЁ>%a]'] = 'ОН';
	LFGSort_Inst['[^А-ЯЁ%a]MC[^А-ЯЁ>%a]'] = 'ОН';
	LFGSort_Inst['[mM]olten [Cc]ore'] = 'ОН';
	LFGSort_Inst['[нН]едра'] = 'ОН';
	LFGSort_Inst['НЕДРА'] = 'ОН';
	LFGSort_Inst['[^А-ЯЁ%a]ОН[^А-ЯЁ%a]'] = 'ОН';
	-- 26. БВЛ
	...
	LFGSort_Inst['.*[Лл]огов.*[Кк]рыл.*[Тт]ьм.*'] = 'БВЛ';
	LFGSort_Inst['.*ЛОГОВ.*КРЫЛ.*ТЬМ.*'] = 'БВЛ';
	--LFGSort_Inst['лкт'] = 'БВЛ'
	-- 27. Накс

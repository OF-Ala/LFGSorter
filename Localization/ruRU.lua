...
LFGSort_Inst_ect = {};
	...
	LFGSort_Inst2['[^А-ЯЁа-я%a][Мм]ару'] = 'МАРА';
	...
	LFGSort_Inst6['.*[Гг]р.-бн.*[Мм]ан.*'] = 'ГМ';
	LFGSort_Inst6['ГР.-БН.*МА'] = 'ГМ';
	
	LFGSort_Inst6['[Аа]ук.*[Гг]робн'] = 'АУКГ'; -- аукенайские гробницы
	...
	LFGSort_Inst6['ПП[^А-ЯЁа-я%a]'] = 'ПП'; -- паровое подземелье
	...
	LFGSort_Inst6['[^%a]ботан'] = 'БОТ'; -- ботаника
	LFGSort_Inst6['[^%a]Ботан'] = 'БОТ'; -- ботаника
	
	LFGSort_Inst6['^А-ЯЁа-я%a%/]ЧТ[^А-ЯЁа-я%a%/]'] = 'ЧТ'; -- Черные топи
	LFGSort_Inst6['[^А-ЯЁа-я%a][Тт]опи'] = 'ЧТ'; -- Черные топи
	...
	LFGSort_Inst6['[^А-ЯЁа-я%a][Аа]рка'] = 'АРКА'; -- акратрац
	...
	LFGSort_Inst5['[Гг]ероик[А-ЯЁа-я%a]'] = 'ГЕР';
	LFGSort_Inst5['[^А-ЯЁа-я%a][Гг]ер[^А-ЯЁа-я%a]'] = 'ГЕР';
...
--[^А-ЯЁ%a]
	...
	LFGSort_Inst4['[^А-ЯЁа-я%a][Кк]ар[ау][^А-ЯЁ%a]'] = 'КАРА'; -- каражан
